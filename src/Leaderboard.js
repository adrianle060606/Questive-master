                ...
                <tbody>
                    ...
                    {overallData.map((item, index) => (
                        <tr key={item.id}>
                            ...
                            <th>{item.name}{course === "Ext2" && (
                                item.name === "Lachlan Watts" ||
                                item.name === "Matthew Adler" ||
                                item.name === "Matthew Smith" ||
                                item.name === "Daniel Christolis"
                            ) ? (item.name === "Matthew Smith" ? " 👀👀" : " 👀") : ""}{(course === "Ext1" && item.name === "Matthew Smith") ? " 👀" : ""}</th>
                    ...
                    {course === "Ext2" ? <tr>
                        {getOrdinalHTML(41)}
                        <th>Morgan Stoodley</th>
                        <th>
                            <div id="leaderboard-math">
                                {`$$e^{i\\pi}+1$$`}
                            </div>
                        </th>
                    </tr> : <div></div>}
