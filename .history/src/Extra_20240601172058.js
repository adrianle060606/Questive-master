import { collection, query, where, getDocs, addDoc, doc, updateDoc, orderBy, deleteField } from 'firebase/firestore';
...
export { resetAnswered, ordinalSuffixOf, getOrdinalHTML, gainedPointsFromRankArray, gainedPointsFromUser, updateRanks, updateOverallPoints };