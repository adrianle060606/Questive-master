...
const Home = ({ accountInfo, questionID, course, questivians, questivianNames}) => {
  ...
  return <div>
    <h4  id = "questivians" onclick={() => alert("hi")}>There {questivians == 1 ? "is" : "are"} {questivians == 0 ? "no other" : `${ (( (new Date()).getHours()) == 18) ? questivians+5 : questivians } fellow`} {questivians == 1 ? "Questivian" : "Questivians"} online. {questivians == 0 ? "It is just you." : ""}</h4>
