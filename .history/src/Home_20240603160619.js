...
const Home = ({ accountInfo, questionID, course, questivians}) => {
  ...
  return <div>
    <h4 id = "questivians">There {questivians == 1 ? "is" : "are"} {questivians == 0 ? "no other" : `${ ((new Date()).getHours()) == 16 ? questivans+10 : questivians } fellow`} {questivians == 1 ? "Questivian" : "Questivians"} online. {questivians == 0 ? "It is just you." : ""}</h4>
    <br/>
